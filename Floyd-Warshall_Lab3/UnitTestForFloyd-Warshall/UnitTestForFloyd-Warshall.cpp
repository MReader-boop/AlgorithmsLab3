...
namespace UnitTestForAlgorithmFloydWarshall
{
	TEST_CLASS(UnitTestForAlgorithmFloydWarshall)
	{
	public:

		TEST_METHOD(TestExamplePath_is_avaible)
		{
			ifstream vvod("C:\\Users\\klesovi\\Desktop\\Floyd-Warshall_Lab3\\UnitTestForFloyd-Warshall\\input1.txt");
		...
		{
			ifstream vvod("C:\\Users\\klesovi\\Desktop\\Floyd-Warshall_Lab3\\UnitTestForFloyd-Warshall\\input2.txt");
			List<string>* list_fly = new List<string>();
